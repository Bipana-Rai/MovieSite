  ...
  return (
    <footer className="bg-[#030814]  lg:px-5 mb-0 bottom-0 ">
      <div className="flex items-center justify-center flex-col    text-white  p-10">
        ...
        <div className="w-[100%] lg:w-[50%] text-[14px] py-4  text-center">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore
          quibusdam amet voluptatem voluptates? Fugiat expedita repellendus
          vitae dolores a, facilis quis. Voluptas sapiente aliquid vel in sed
